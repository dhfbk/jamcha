...
* FeatureSectionValuesConstraints: classe che contiene i valori massimi e minimi di ogni singola sezione di una feature.
                                  ...
                                  Es. F:-2,-1:x..y  il valore minimo di x è zero(non esiste una colonna negativa). Il valore massimo sia di x che y è il numero
                                                    delle colonne meno 1 (perchè l'ultima è quella dei TAG)
