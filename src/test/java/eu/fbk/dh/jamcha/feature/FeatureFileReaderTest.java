...
public class FeatureFileReaderTest
{
    ...
    // Test file path
    public static final Path DEFAULT_TRAIN_FILE_PATH = Paths.get("DefaultLineFeatures.txt");
    public static final Path DEFAULT_PREDICT_FILE_PATH = Paths.get("DefaultLineFeaturesPredict.txt");
