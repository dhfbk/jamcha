...
public class FeatureIntegratorTest
{
    ...
    private final FeatureIntegrator integrator;
    private final FeatureParserSelectorTest selectorTest;
    private final FeatureFileReaderTest readerTest;
    ...
    public void testIntegrateFeatures() throws IOException
    {
        ...
        // Ordina le feature per ogni riga altrimenti la equals fallisce
