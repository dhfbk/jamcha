...
public final class FeatureParserSelector
{
    ...
    private final class FeatureNames
    {
         ...
         */
        private static final char FEATURE_STATIC = 'F';
        /**
         * Dynamic feature name constant
         */
        private static final char FEATURE_DYNAMIC = 'T';
    }
...
//    }
     ...
     *
     * @param featureToParse feature string written with this pattern: featureName:featurePattern. (e.g. T:-5..-2). This method reads only featureName, that must consist
     *                       of only one char. If last condition (one char) is not respected no exception is thrown.
     */
     ...
     * @param numberOfColumns number of columns in the training file, tag column included
     */
    public FeatureParserSelector(int numberOfColumns)
    {
